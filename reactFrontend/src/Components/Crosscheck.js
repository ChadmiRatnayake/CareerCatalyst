                        ...
                        <div className="col-md-6">
                            <div className="row">
                                <div className="col-md-3">
                                    ...
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem1InBox}>
                                        {item1InBox ? 'Remove C' : 'C'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem2InBox}>
                                        {item2InBox ? 'Remove C++' : 'C++'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem3InBox}>
                                        {item3InBox ? 'Remove C#' : 'C#'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem4InBox}>
                                        {item4InBox ? 'Remove Java' : 'Java'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem5InBox}>
                                        {item5InBox ? 'Remove Python' : 'Python'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem6InBox}>
                                        {item6InBox ? 'Remove PHP' : 'PHP'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem7InBox}>
                                        {item7InBox ? 'Remove Go' : 'Go'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem8InBox}>
                                        {item8InBox ? 'Remove SQL' : 'SQL'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem9InBox}>
                                        {item9InBox ? 'Remove MySQL' : 'MySQL'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem10InBox}>
                                        {item10InBox ? 'Remove PostgreSQL' : 'PostgreSQL'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem11InBox}>
                                        {item11InBox ? 'Remove MongoDB' : 'MongoDB'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem12InBox}>
                                        {item12InBox ? 'Remove SQL Server' : 'SQL Server'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem13InBox}>
                                        {item13InBox ? 'Remove Oracle SQL' : 'Oracle SQL'}
                                    </button>
                                </div>
                                <div className="col-md-3">
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem14InBox}>
                                        {item14InBox ? 'Remove Git' : 'Git'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem15InBox}>
                                        {item15InBox ? 'Remove GitHub' : 'GitHub'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem16InBox}>
                                        {item16InBox ? 'Remove GitLab' : 'GitLab'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem17InBox}>
                                        {item17InBox ? 'Remove AWS' : 'AWS'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem18InBox}>
                                        {item18InBox ? 'Remove Azure' : 'Azure'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem19InBox}>
                                        {item19InBox ? 'Remove GCP' : 'GCP'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem20InBox}>
                                        {item20InBox ? 'Remove Postman' : 'Postman'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem21InBox}>
                                        {item21InBox ? 'Remove Twilio' : 'Twilio'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem22InBox}>
                                        {item22InBox ? 'Remove Docker' : 'Docker'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem23InBox}>
                                        {item23InBox ? 'Remove Kubernetes' : 'Kubernetes'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem24InBox}>
                                        {item24InBox ? 'Remove HTML' : 'HTML'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem25InBox}>
                                        {item25InBox ? 'Remove CSS' : 'CSS'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem26InBox}>
                                        {item26InBox ? 'Remove Bootstrap' : 'Bootstrap'}
                                    </button>
                                </div>
                                <div className="col-md-3">
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem27InBox}>
                                        {item27InBox ? 'Remove Tailwind' : 'Tailwind'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem28InBox}>
                                        {item28InBox ? 'Remove JavaScript' : 'JavaScript'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem29InBox}>
                                        {item29InBox ? 'Remove TypeScript' : 'TypeScript'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem30InBox}>
                                        {item30InBox ? 'Remove React' : 'React'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem31InBox}>
                                        {item31InBox ? 'Remove Angular' : 'Angular'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem32InBox}>
                                        {item32InBox ? 'Remove Vue' : 'Vue'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem33InBox}>
                                        {item33InBox ? 'Remove Node' : 'Node'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem34InBox}>
                                        {item34InBox ? 'Remove Django' : 'Django'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem35InBox}>
                                        {item35InBox ? 'Remove Flask' : 'Flask'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem36InBox}>
                                        {item36InBox ? 'Remove Spring Boot' : 'Spring Boot'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem37InBox}>
                                        {item37InBox ? 'Remove Laravel' : 'Laravel'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem38InBox}>
                                        {item38InBox ? 'Remove Ruby on Rails' : 'Ruby on Rails'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem39InBox}>
                                        {item39InBox ? 'Remove .NET Core' : '.NET Core'}
                                    </button>
                                </div>
                                <div className="col-md-3">
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem40InBox}>
                                        {item40InBox ? 'Remove Dart' : 'Dart'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem41InBox}>
                                        {item41InBox ? 'Remove Flutter' : 'Flutter'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem42InBox}>
                                        {item42InBox ? 'Remove React Native' : 'React Native'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem43InBox}>
                                        {item43InBox ? 'Remove Kotlin' : 'Kotlin'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem44InBox}>
                                        {item44InBox ? 'Remove Android Jetpack' : 'Android Jetpack'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem45InBox}>
                                        {item45InBox ? 'Remove Android Studio' : 'Android Studio'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem46InBox}>
                                        {item46InBox ? 'Remove Swift' : 'Swift'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem47InBox}>
                                        {item47InBox ? 'Remove SwiftUI' : 'SwiftUI'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem48InBox}>
                                        {item48InBox ? 'Remove Ionic' : 'Ionic'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem49InBox}>
                                        {item49InBox ? 'Remove Xcode' : 'Xcode'}
                                    </button>
                                    <button type="button" class="btn card_button" style={{ color: 'white', backgroundColor: '#03738a'}} onClick={toggleItem50InBox}>
