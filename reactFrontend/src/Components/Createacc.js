                        ...
                        <div class="createacc">
                            ...
                            <form onSubmit={handleSubmit} class="form-inline"> 
                                ...
                                <div>
                                    <div className="col">
                                        <div className="form-group">
                                            <input type="text" name='address' placeholder="Address" class="form-control mb-2" value={address} onChange={handleAddressChange} required/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group">
                                            <input type="text" name='postalcode' placeholder="Postal Code" class="form-control mb-2" value={postalcode} onChange={handlePostalCodeChange} required/>
                                        </div>
                                    </div>
                                    <div className="col">
                                ...
                                <div class="acc">
                                    <p>Already have an account ? <a onClick={handleclick3}><b style={{ color: '#03738a' }}>Log In here</b></a></p>
                                </div>
